...
$|Phi chevron.r$ — волновая функция, $E$ — энергия. Необходимо
...
полный набор, и любая функция $|tilde(Phi) chevron.r$,
удовлетворяющая тем же граничным условиям, что и набор
$brace.l|Phi_alpha chevron.r brace.r$, может быть представлена
как линейная комбинация $|Phi_alpha chevron.r$
