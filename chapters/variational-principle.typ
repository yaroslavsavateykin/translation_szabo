...
функция $|tilde(Phi) chevron.r$, удовлетворяющая граничным условиям
(чаще всего стремлению к 0 на бесконечности), то среднее значение
энергии, рассчитанное на этой функции, является оценкой сверху для
