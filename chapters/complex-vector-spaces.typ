...
После выбора базиса вектор $|a chevron.r$ можно полностью
описать, задав его $N$ компонент $a_i$,
$i eq 1 comma 2 comma dots.h comma N$, относительно базиса
$brace.l|i chevron.r brace.r$. Как и раньше, мы располагаем эти
...
произведение бра-вектора $chevron.l a|$ и кет-вектора
...
уравнении (1.4). Необычные названия бра (для $chevron.l|$) и кет
(для $|chevron.r$) были выбраны потому, что запись скалярного
произведения $chevron.l|chevron.r$ напоминает слово bracket,
...
Тогда скалярное произведение $chevron.l a|$ и $|b chevron.r$
принимает вид
...
$chevron.l b|$ — матрицей-строкой $bold(b)^dagger$, а их
...
$brace.l|i chevron.r brace.r$ или
$brace.l chevron.l i|brace.r$? Мы действуем в полной аналогии с
трёхмерным случаем (ср. уравнение (1.8)). Умножим уравнение @eq:141
слева на $chevron.l j|$, а уравнение @eq:146 справа на
$|j chevron.r$ и получим
...
объект, который, действуя на кет $|a chevron.r$, переводит его в
кет $|b chevron.r$:
...
части уравнения @eq:152 слева на $chevron.l c|$ и обе части
уравнения @eq:157 справа на $|c chevron.r$, получаем
