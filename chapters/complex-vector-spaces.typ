...
базисных векторов, обозначаемых символом $bar.v i chevron.r$,
$i eq 1 comma 2
...
кет-вектор $bar.v a chevron.r$ можно записать в виде
...
После выбора базиса вектор $bar.v a chevron.r$ можно полностью
описать, задав его $N$ компонент $a_i$,
$i eq 1 comma 2 comma dots.h comma N$, относительно базиса
$brace.l bar.v i chevron.r brace.r$. Как и раньше, мы располагаем эти
числа в матрицу-столбец $bold(a)$:
...
абстрактного вектора $bar.v a chevron.r$ в базисе
$brace.l bar.v i chevron.r brace.r$. Напомним (уравнение (1.27)), что
...
произведение бра-вектора $chevron.l a bar.v$ и кет-вектора
$bar.v b chevron.r$ определяется как
...
уравнении (1.4). Необычные названия бра (для $chevron.l bar.v$) и кет
(для $bar.v chevron.r$) были выбраны потому, что запись скалярного
...
Тогда скалярное произведение $chevron.l a bar.v$ и $bar.v b chevron.r$
принимает вид
...
обобщением уравнения (1.7). Итак, кет-вектор $bar.v a chevron.r$
представляется матрицей-столбцом $bold(a)$, бра-вектор
$chevron.l b bar.v$ — матрицей-строкой $bold(b)^dagger$, а их
скалярное произведение есть просто матричное произведение этих
представлений.
...
трёхмерным случаем (ср. уравнение (1.8)). Умножим уравнение @eq:141
слева на $chevron.l j bar.v$, а уравнение @eq:146 справа на
...
формой высказывания «взять скалярное произведение с
$chevron.l j bar.v$». Заметим, что
...
объект, который, действуя на кет $bar.v a chevron.r$, переводит его в
кет $bar.v b chevron.r$:
...
действует на базис $brace.l bar.v i chevron.r brace.r$:
...
части уравнения @eq:152 слева на $chevron.l c bar.v$ и обе части
уравнения @eq:157 справа на $bar.v c chevron.r$, получаем
