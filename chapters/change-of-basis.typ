...
$brace.l|i chevron.r brace.r$ и $brace.l|alpha chevron.r brace.r$;
теперь нужно найти связь между ними. Для обозначения бра- и
кет-векторов первого базиса будем использовать латинские буквы
$i comma j comma k comma dots.h$, а для бра- и кет-векторов второго
базиса — греческие буквы $alpha comma beta comma gamma$. Поэтому имеем
...
Поскольку базис $brace.l|i chevron.r brace.r$ полон, любой кет из
базиса $brace.l|alpha chevron.r brace.r$ можно выразить как линейную
комбинацию кетов базиса $brace.l|i chevron.r brace.r$, и наоборот. То
есть
...
которого в базисе $brace.l|i chevron.r brace.r$ недиагонально, всегда
можно найти базис $brace.l|alpha chevron.r brace.r$, в котором
матричное представление оператора диагонально, т. е.
