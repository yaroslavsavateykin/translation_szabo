...
$
  hat(H)_0 eq sum_i f (i) eq sum_i [hat(h) (i) plus hat(v)^(upright("HF")) (i)]
$

и

$
  hat(V) eq sum_(i lt j) r_(i j)^(minus 1) minus hat(V)^(upright("HF")) eq sum_(i lt j) r_(i j)^(minus 1) minus sum_i hat(v)^(upright("HF")) (i)
$
...
системы. Очевидно, мы полагаем $|0 chevron.r eq| Psi_0 chevron.r$,
...
$ E_0^((2)) eq sum_(a lt b) e_(a b)^(upright("FO")) $
...
$
  E_(upright("corr")) eq E_0^((2)) plus E_0^((3)) plus dots.h
$

где

$
  E_0^((2)) eq frac(K_12^2, 2 (epsilon_1 minus epsilon_2))
$ <eq:ref677>

и

$
  E_0^((3)) eq frac(K_12^2 (J_11 plus J_22 minus 4 J_12 plus 2 K_12), 4 (epsilon_1 minus epsilon_2)^2)
$ <eq:ref678>
