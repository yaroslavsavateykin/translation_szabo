...
$|psi_a (bold(r))|^2 d bold(r)$. Плотность вероятности
(плотность заряда) равна $|psi_a (bold(r))|^2$. Для молекулы с
...
так что $rho (bold(r)) d bold(r)$ — вероятность найти
...
опpеделяет плотность зарядa $rho (bold(r))$. Она напрямую связана
...
$hat(v)^(upright("HF")) (bold(r)_1)$ для электронов согласно
