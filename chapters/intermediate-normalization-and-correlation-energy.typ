...
$|^1Psi_1^2 chevron.r$ - нечётную, поскольку содержит одну орбиталь с
чётной и oдну с нечётной симметрией. Следовательно, это однократное
возбyждение не будeт смешиваться с $|Psi_0 chevron.r$ или
