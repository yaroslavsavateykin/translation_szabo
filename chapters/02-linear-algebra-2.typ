...
<математический-обзор-1-1-4-1-1-7>
...
использовать удобную нотацию, введённую Дираком, позволяющую записывать
...
$
  chevron.l a bar.v b chevron.r eq chevron.l a b chevron.r eq bold(a)^dagger bold(b)
...
$omega_alpha neq omega_beta$. Следовательно, ортогональность немедленно
...
$chevron.l 1 bar.v 2 chevron.r eq S neq 0$. Выберем
...
нетривиальное решение ($bold(c) neq 0$) только тогда, когда
