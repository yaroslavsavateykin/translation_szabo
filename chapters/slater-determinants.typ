...
где $(N excl)^(minus 1 slash 2)$ является нормировочным
множителем. Этот определитель Слейтера содержит $N$ электронов,
занимающиx $N$ спин-орбиталей
$(chi_i comma chi_j comma dots.h comma chi_k)$, без указания,
...
первая строка $(bold(x)_1)$, вторая строка $(bold(x)_2)$ и так
...
$P (bold(r)_1 comma bold(r)_2) d bold(r)_1 d bold(r)_2$ —
...
$P (bold(r)_1 comma bold(r)_1) eq 0$, и, следовательно,
