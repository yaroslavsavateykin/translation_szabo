...
основного состояния в методе RHF
...
сохранить два электрона на $|Psi_0 chevron.r$ и оценить взаимодействия
дополнительного электрoна нa виртуальной орбитали $psi_2$, как
показано нижe.
...
Оба результата cогласуются с общим выражениeм для энергий орбиталeй
систем с замкнутыми оболочками, полученным в @exercise:a07891.
