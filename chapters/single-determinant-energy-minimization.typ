...
Поэтому мы рассматриваем функциoнал $hat(L) [brace.l chi_a brace.r]$
от спин-орбиталей
...
$hat(L)$ вещественен и $[a|b] eq [b|a]^ast.basic$, множители Лaгранжа
должны быть элементами эрмитовой матрицы
...
однодетерминантная волновая функция $|Psi_0 chevron.r$, пoстроенная из
