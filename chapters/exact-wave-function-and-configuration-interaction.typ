...
$brace.l chi_i|i eq 1 comma 2 comma dots.h comma 2 K brace.r$, то
$binom(2 K, N)$ детерминaнтов, образованных из этих спин-орбиталей, не
образуют полный $N$-электронный базис. Тем не менее, диагонализация
