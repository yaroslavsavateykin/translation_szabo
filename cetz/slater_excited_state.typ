...
#let slater_excited_state() = {
  cetz.canvas({
    ...
    content(
      (4.5, 6.5),
      text(size: text-size)[ $|Psi_a^r chevron.r$ ],
      anchor: "east",
    )
    ...
    // Уровень chi_2K (Ширина ровно 3.5: от 6.25 до 9.75)
    ...
    // Уровень chi_r (занят возбужденным электроном)
    ...
    // ==========================================
    // СТРУКТУРНАЯ СТРЕЛКА ВОЗБУЖДЕНИЯ
    // ==========================================
    // Чуть сдвинута от центра (X=7.35), чтобы аккуратно вписаться в новую ширину
    line(
      (7.35, 5.0),
      (7.35, 12.0),
